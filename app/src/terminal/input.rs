...
use crate::util::bindings::{
    self, BindingDescriptionFluentExt, CustomAction, keybinding_name_to_normalized_string,
};
#[cfg(feature = "local_fs")]
...
pub fn init(app: &mut AppContext) {
    ...
    app.register_editable_bindings([EditableBinding::new(
        ...
        BindingDescription::new(warp_i18n::t!("command-edit-prompt"))
            .with_custom_description(bindings::MAC_MENUS_CONTEXT, warp_i18n::t!("command-edit-prompt")),
