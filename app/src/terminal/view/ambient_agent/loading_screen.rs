...
pub fn render_cloud_mode_error_screen(
    ...
    let title_text = Text::new(
        // Fork: `presentation.title` is the English "Failed to start environment";
        // render the localized string instead.
...
pub fn render_cloud_mode_github_auth_required_screen(
    ...
    let title_text = Text::new(
        // Fork: localized counterpart of `presentation.title`.
    ...
    let message_text = Text::new(
        // Fork: `presentation.detail` for `RetryRetainedRequest` is the English
        // "Please authenticate with GitHub to continue"; use the localized string.
