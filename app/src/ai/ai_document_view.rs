    ...
    pub fn new(
        ...
        let version_button = ctx.add_typed_action_view(|_| {
            ActionButton::new("", NakedTheme)
                ...
                .with_tooltip(t!("ai-ui-show-version-history"))
                .on_click(|ctx| {
        ...
        let tooltip_text = t!("ai-ui-update-agent-tooltip", shortcut = save_action);
        let update_plan_button = ctx.add_typed_action_view(|_ctx| {
            ActionButton::new(t!("ai-ui-update-agent"), PrimaryTheme)
                .with_size(ButtonSize::Small)
        ...
        let restore_button = ctx.add_typed_action_view(|_ctx| {
            ActionButton::new(t!("ai-ui-restore"), SecondaryTheme)
                .with_size(ButtonSize::Small)
                .on_click(|ctx| {
                    ctx.dispatch_typed_action(
                        PaneHeaderAction::<AIDocumentAction, AIDocumentAction>::CustomAction(
        ...
        match save_status {
            AIDocumentSaveStatus::NotSaved => {
                ...
                let tooltip = ui_builder
                    .tool_tip(t!("ai-ui-plan-save-sync-tooltip"))
                    .build()
                    .finish();
...
impl BackingView for AIDocumentView {
    ...
    fn pane_header_overflow_menu_items(
            ...
            AIDocumentModel::as_ref(ctx).get_document_warp_drive_object_link(&self.document_id, ctx)
        {
            ...
            menu_items.push(
                MenuItemFields::new(t!("ai-ui-show-in-warp-drive"))
        ...
        {
            menu_items.push(
                crate::menu::MenuItemFields::new(t!("ai-ui-save-markdown-file"))
        ...
        menu_items.push(
            MenuItemFields::new(t!("ai-ui-attach-active-session"))
        ...
        menu_items.push(
            MenuItemFields::new(t!("ai-ui-copy-plan-id"))
