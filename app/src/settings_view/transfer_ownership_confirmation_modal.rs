...
impl View for TransferOwnershipConfirmationModal {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let description_text = Text::new(
            warp_i18n::t!(
                "settings-environments-transfer-ownership-modal-description",
                email = email
            )
            .to_string(),
        ...
        let buttons_row = Flex::row()
            ...
            .with_child(
                appearance
                    ...
                    .with_text_label(
                        warp_i18n::t!("settings-environments-transfer-ownership-modal-cancel")
                            .to_string(),
                    )
            ...
            .with_child(
                Container::new(
                    appearance
                        ...
                        .with_text_label(
                            warp_i18n::t!("settings-environments-transfer-ownership-modal-confirm")
                                .to_string(),
                        )
                        .with_style(button_style)
                        .build()
