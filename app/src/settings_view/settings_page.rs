...
use crate::view_components::{
    Dropdown, DropdownItemAction, FilterableDropdown, SubmittableTextInput, ToastFlavor,
};
...
pub fn render_info_icon<T: Clone + Action>(
    ...
    let tooltip_text = additional_info
        ...
        .unwrap_or_else(|| warp_i18n::t!("settings-page-tooltip-default-learn-more").to_string());
