...
pub fn init_actions_from_parent_view<T: Action + Clone>(
    ...
    let autodetection_suffix = if FeatureFlag::AgentView.is_enabled() {
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![
            ToggleSettingActionPair::new(
                &warp_i18n::t!("settings-ai-cmd-suffix-hash-trigger-command-search"),
                builder(SettingsAction::WarpAgent(
    ...
    fn build_page(ctx: &mut ViewContext<Self>) -> PageType<Self> {
                    ...
                    .is_supported_on_current_platform())
        {
            ...
            categories.push(Category::with_header(
                CategoryHeader::new(warp_i18n::t_static!("settings-ai-active-ai"))
                    .with_trailing_element(move |_view, _appearance, app| {
                        render_active_ai_toggle(&active_ai_toggle, app)
                    }),
                active_ai_widgets,
            ));
        }
        ...
        categories.push(Category::new(
            warp_i18n::t_static!("settings-ai-attribution-section"),
        ...
        if FeatureFlag::AgentModeComputerUse.is_enabled() {
            categories.push(Category::new(
                warp_i18n::t_static!("settings-ai-experimental"),
        ...
        PageType::new_categorized(
            categories,
            Some(
                PageTitle::new(warp_i18n::t_static!("settings-ai-warp-agent"))
                    .with_trailing_element(move |_view, appearance, app| {
    ...
    fn render_natural_language_detection_section(
        ...
        section
            .with_child(render_ai_setting_label::<AICommandDenylist>(
                warp_i18n::t!("settings-ai-natural-lang-denylist"),
                is_toggleable,
                &view.local_only_icon_tooltip_states,
                app,
            ))
    ...
    fn render_voice_section(
        ...
        if ai_settings.is_voice_input_enabled(app) {
            column.add_child(render_dropdown_item(
                ...
                Some(warp_i18n::t!("settings-ai-voice-input-key-tip").as_str()),
                None,
                LocalOnlyIconState::for_setting(
...
impl SettingsWidget for ThinkingDisplayModeWidget {
    ...
    fn render(
        ...
        render_dropdown_item(
            ...
            Some(warp_i18n::t!("settings-ai-thinking-display-desc").as_str()),
            None,
            LocalOnlyIconState::for_setting(
    ...
    fn render(
        ...
        let toggle_row = build_toggle_element(
            render_body_item_label::<WarpAgentPageAction>(
                warp_i18n::t!("settings-ai-attribution-toggle"),
...
impl SettingsWidget for CloudAgentComputerUseWidget {
    ...
    fn render(
        ...
        let toggle_row = build_toggle_element(
            render_body_item_label::<WarpAgentPageAction>(
                warp_i18n::t!("settings-ai-cloud-computer-use"),
...
impl ApiKeysWidget {
    ...
    fn render_provider_key_editors(
        ...
        for provider_editor in &self.provider_api_key_editors {
            // The three providers the fork localizes keep their translated
            // labels; anything upstream adds later falls back to the generic
            // "<provider> API key" label.
