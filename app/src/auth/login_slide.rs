    ...
    fn copy(self) -> (String, String) {
        match self {
            ...
            LoginPurpose::AccountFirst => (
                ...
                "Access AI, run cloud agents, collaborate with teammates, and sync settings across devices.".to_string(),
            ),
        }
    }
...
impl LoginSlideView {
    ...
    fn render_select_auth_content(&self, appearance: &Appearance) -> Vec<Box<dyn Element>> {
        ...
        let tos_line = Flex::row()
            ...
            .with_child(
                ui_builder
                    .link(
                        warp_i18n::t!("onboarding-login-disclaimer-tos-link").into(),
                        Some(TOS_URL.into()),
                        None,
        ...
        let privacy_line = Flex::row()
            ...
            .with_child(
                ui_builder
                    .link(
                        warp_i18n::t!("onboarding-login-disclaimer-privacy-link").into(),
                        None,
                        Some(Box::new(|ctx| {
    ...
    fn render_select_auth_bottom_nav(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let skip_label = match self.login_purpose() {
            ...
            LoginPurpose::WarpAgent => warp_i18n::t!("onboarding-login-skip-for-now"),
            LoginPurpose::ThirdParty => warp_i18n::t!("onboarding-login-skip-for-now"),
            LoginPurpose::AccountFirst => "Skip".to_string(),
        };
    ...
    fn render_browser_open_content(
        ...
        let title = FormattedTextElement::from_str(
            warp_i18n::t!("onboarding-login-browser-title"),
            ...
            .with_child(
                Flex::row()
                    ...
                    .with_child(
                        ui_builder
                            .link(
                                warp_i18n::t!("onboarding-login-browser-hint-link-copy").into(),
                                None,
                                Some(Box::new(|ctx| {
        ...
        let auth_token: Box<dyn Element> = if self.show_auth_token_input {
            ...
            Flex::row()
                .with_child(
                    ui_builder
                        .link(
                            warp_i18n::t!("onboarding-login-browser-token-link").into(),
                            None,
                            Some(Box::new(|ctx| {
