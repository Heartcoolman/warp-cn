...
command-slash-fork-desc = Fork the current conversation
...
command-slash-usage-desc = View account and credit usage
...
command-slash-status-desc = Show session and account status
command-slash-voice-desc = Start voice input (Ctrl-S)
command-slash-statusline-desc = Configure the statusline
command-slash-reset-statusline-desc = Reset the statusline to its default items and ordering
command-slash-api-keys-desc = View and manage API keys
command-slash-connect-grok-desc = Connect your Grok (X Premium / SuperGrok) account
command-slash-manage-billing-desc = Open the team billing page in your browser
command-slash-upgrade-desc = Open the Warp upgrade page in your browser
command-slash-theme-desc = Set color theme
command-slash-clear-desc = Clear the transcript and start a new conversation (alias for /agent)
command-slash-vim-mode-desc = Toggle Vim mode
command-slash-copy-debugging-id-desc = Copy debugging information for this conversation
command-slash-auto-approve-desc = Toggle auto approve
command-slash-exit-desc = Exit Warp
command-slash-logout-desc = Log out of Warp
command-slash-mcp-desc = View and manage MCP servers
command-slash-natural-language-detection-desc = Toggle natural language detection
command-slash-view-logs-desc = Bundle your logs into a zip archive
command-slash-team-desc = Switch the active team
