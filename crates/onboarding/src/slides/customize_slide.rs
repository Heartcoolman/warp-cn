...
impl CustomizeUISlide {
    ...
    fn render_header(&self, appearance: &Appearance) -> Box<dyn Element> {
        let title = appearance
            .ui_builder()
            .paragraph(warp_i18n::t!("onboarding-customize-title"))
        ...
        let subtitle = FormattedTextElement::from_str(
            warp_i18n::t!("onboarding-customize-subtitle"),
    ...
    fn render_tab_styling_card(
        ...
        render_toggle_card(
            appearance,
            ToggleCardSpec {
                title: warp_i18n::t!("onboarding-customize-tab-styling-title"),
                is_expanded: is_selected,
                is_left_selected: ui.use_vertical_tabs,
                left_label: warp_i18n::t!("onboarding-customize-tab-vertical"),
                right_label: warp_i18n::t!("onboarding-customize-tab-horizontal"),
    ...
    fn render_tools_panel_card(
        ...
        if ui.tools_panel_enabled(&intention) {
            chips.push(ChipSpec {
                label: warp_i18n::t!("onboarding-customize-chip-file-explorer"),
            ...
            if is_agent {
                chips.push(ChipSpec {
                    label: warp_i18n::t!("onboarding-customize-chip-conversation"),
            ...
            chips.push(ChipSpec {
                label: warp_i18n::t!("onboarding-customize-chip-global-search"),
            ...
            chips.push(ChipSpec {
                label: warp_i18n::t!("onboarding-customize-chip-warp-drive"),
        ...
        render_toggle_card(
            appearance,
            ToggleCardSpec {
                title: warp_i18n::t!("onboarding-customize-tools-panel-title"),
                is_expanded: is_selected,
                is_left_selected: ui.tools_panel_enabled(&intention),
                left_label: warp_i18n::t!("onboarding-toggle-enabled"),
                right_label: warp_i18n::t!("onboarding-toggle-disabled"),
    ...
    fn render_code_review_card(
        ...
        render_toggle_card(
            appearance,
            ToggleCardSpec {
                title: warp_i18n::t!("onboarding-customize-code-review-title"),
                is_expanded: is_selected,
