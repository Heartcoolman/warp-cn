...
impl View for IntroSlide {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let login_row = Flex::row()
            .with_child(
                ui_builder
                    .span(format!("{} ", warp_i18n::t!("onboarding-intro-already-have-account")))
            ...
            .with_child(
                ui_builder
                    .link(
                        warp_i18n::t!("onboarding-intro-log-in").into(),
                        None,
                        Some(Box::new(|ctx| {
...
impl IntroSlide {
    fn render_centered_content(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let title = ShimmeringTextElement::new(
            warp_i18n::t!("onboarding-intro-welcome"),
        ...
        let subtitle = FormattedTextElement::from_str(
            warp_i18n::t!("onboarding-intro-subtitle"),
            appearance.ui_font_family(),
            16.,
        )
        ...
        let get_started_button = self.get_started_button.render(
            appearance,
            button::Params {
                content: button::Content::Label(warp_i18n::t!("onboarding-intro-get-started").into()),
