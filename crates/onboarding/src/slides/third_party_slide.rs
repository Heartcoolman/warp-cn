...
impl ThirdPartySlide {
    ...
    fn render_header(&self, appearance: &Appearance) -> Box<dyn Element> {
        let title = appearance
            .ui_builder()
            .paragraph(warp_i18n::t!("onboarding-third-party-title"))
        ...
        let subtitle = FormattedTextElement::from_str(
            warp_i18n::t!("onboarding-third-party-subtitle"),
    ...
    fn render_toolbar_section(
        ...
        let card = render_toggle_card(
            appearance,
            ToggleCardSpec {
                title: warp_i18n::t!("onboarding-third-party-cli-toolbar-title"),
    ...
    fn render_notifications_section(
        ...
        let card = render_toggle_card(
            appearance,
            ToggleCardSpec {
                title: warp_i18n::t!("onboarding-third-party-notifications-title"),
                is_expanded: is_selected,
