...
impl AgentOnboardingView {
    ...
    fn render_no_ai_dialog(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let cancel_button = self.no_ai_cancel_button.render(
            ...
            button::Params {
                content: button::Content::Label(
                    warp_i18n::t!("onboarding-no-ai-dialog-cancel").into(),
                ),
                theme: &button::themes::Naked,
                options: button::Options {
                    on_click: Some(Box::new(|ctx, _app, _pos| {
        ...
        let confirm_button = self.no_ai_confirm_button.render(
            ...
            button::Params {
                content: button::Content::Label(
                    warp_i18n::t!("onboarding-no-ai-dialog-confirm").into(),
                ),
        ...
        render_feature_optout_dialog(
            appearance,
            FeatureOptOutDialog {
                title: warp_i18n::t!("onboarding-no-ai-dialog-title"),
                body: warp_i18n::t!("onboarding-no-ai-dialog-body"),
                features: Vec::new(),
                close_button,
                cancel_button,
                confirm_button,
    ...
    fn render_plan_activated_toast(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let text = ui_builder
            .span(warp_i18n::t!("onboarding-agent-toast-plan-activated"))
